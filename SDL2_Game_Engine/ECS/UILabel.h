...
#include<SDL_ttf.h>
#include <string>
//takes in int xpos, int ypos, std::string text, std::string font, SDL_Color& color to make our label
...
public:
	...
	~UILabel(){}
	//sets the Text for the label and renders it
	...
	//uses SDL_RenderCopy to draw the text to the screen
	void draw() override
	{
